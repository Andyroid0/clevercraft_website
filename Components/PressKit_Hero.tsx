...
const Waves = ({scaleX, scaleY, scale, left, right, opacity, bottom}: any)=>
{
 ...
 const PressKit_Hero = ({ window, props}: PressKit_Hero_type)=>
{
    ...
    <View style={style.hero}>
            ...
            <Text style={{fontSize: 64, fontWeight: '500', color: 'white', alignSelf: 'center'}}>Press Kit</Text>   

            <Text style={{fontSize: 22, fontWeight: '400', color: 'rgba(255,180,90, 1)', alignSelf: 'center'}}>Spread the word.</Text>   
            <View style={{flex:1}}/>
